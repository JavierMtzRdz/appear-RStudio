...
# Update icon
curl -L -o /Applications/RStudio.app/Contents/Resources/RProject.icns https://github.com/amirmasoudabdol/rstudio-icons/raw/main/Icons/macOS/Rectangle/Dark%20Icon%20-%20Rect.icns
